...
/* Definitions for tsk_screen */
osThreadId_t tsk_screenHandle;
const osThreadAttr_t tsk_screen_attributes = {
  .name = "tsk_screen",
  .stack_size = 512 * 4,
  .priority = (osPriority_t) osPriorityLow,
};
/* Definitions for tsk_sensors */
osThreadId_t tsk_sensorsHandle;
const osThreadAttr_t tsk_sensors_attributes = {
  .name = "tsk_sensors",
  .stack_size = 256 * 4,
  .priority = (osPriority_t) osPriorityLow,
};
/* Definitions for tmr_1 */
osTimerId_t tmr_1Handle;
const osTimerAttr_t tmr_1_attributes = {
  .name = "tmr_1"
};
/* USER CODE BEGIN PV */
...
/* USER CODE BEGIN Header_tsk_screen_fn */
/**
* @brief Function implementing the tsk_screen thread.
* @param argument: Not used
* @retval None
*/
...
void tsk_screen_fn(void *argument)
{
  ...
  /* USER CODE END tsk_screen_fn */
}

/* USER CODE BEGIN Header_tsk_sensors_fn */
/**
* @brief Function implementing the tsk_sensors thread.
* @param argument: Not used
* @retval None
*/
